...
const Area2SobreItemA = ({ title, text, link, colorStart }) => {
  return (
    <div className="mb-20 text-center">
      <div className='relative flex justify-center mb-10 gap-2'>
        <div className={`w-8 h-8 self-end rotate-[100deg] rounded-full bg-[conic-gradient(#000000,#3C73F1)]`}></div>
        <div className={`w-20 h-20 self-center rotate-[10deg] rounded-full bg-[conic-gradient(#000000,#3C73F1)]`}></div>
        <div className={`w-4 h-4 self-start rotate-[260deg] rounded-full bg-[conic-gradient(#000000,#3C73F1)]`}></div>
      </div>
...
export default Area2SobreItemA