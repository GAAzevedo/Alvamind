const Area2SobreItem = ({ title, text, colorStart }) => {
  return (
    <div className="mb-20 text-center">
      ...
      <a href="#" className="text-base text-zinc-500 sm:text-lg md:text-xl lg:text-2xl hover:text-200 underline underline-offset-8 hover:text-cyan-500">Saiba mais</a>
    </div>
  )
}
