const Area2SobreItem = ({ title, text, colorStart }) => {
  return (
    <div className="mb-20 text-center">
      ...
      <p className="mb-1 text-base text-zinc-500 sm:mb-3 sm:text-lg md:mb-5 md:text-xl lg:mb-7 lg:text-2xl">{text}</p>
      <a href="#" className="text-base text-zinc-500 sm:text-lg md:text-xl lg:text-2xl hover:text-200 underline underline-offset-8">Saiba mais</a>
    </div>
  )
}
