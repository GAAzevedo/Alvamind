...
const Area1Item = ({ value, img, title, text, page, handleActiveItem, activeItem }) => {
  const isActive = activeItem === value

  const itemClassName = `flex flex-col items-center py-8 p-5 rounded bg-zinc-100 dark:bg-zinc-800 transition duration-150 ${isActive ? 'border border-cyan-500 scale-105	' : ''}`

  return (
    <div className={itemClassName} onClick={() => handleActiveItem(value)}>
      <img src={img} alt="" className='w-16 mb-6' />
