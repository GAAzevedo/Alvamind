...
const HeroWebsite = () => {
  return (
    <section className="hole relative mt-[72px] lg:min-h-[calc(100vh-72px)] lg:mt-[72px] bg-white dark:bg-zinc-950">
        ...
        <div className="grid mt-8 min-h-screen  lg:gap-8 xl:gap-0  lg:grid-cols-12 py-24 px-4 mx-auto max-w-screen-xl sm:py-28 md:py-32 lg:py-36 sm:px-6 md:px-14 lg:px-20">
          ...
          >
            ...
            <p className="leading-loose font-light text-2xl text-zinc-500 lg:mb-8 md:text-lg lg:text-xl dark:text-zinc-400">
