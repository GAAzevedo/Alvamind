    ...
    <section className="section-test">
      <div className="container-test">
        ...
        <div className="gap-8 mt-24 sm:grid grid-cols-2 sm:text-lg  ">
          ...
          <Area3MktItem title="Inovação Contínua" per="30" text="Empresas que adotam inovações em marketing têm um crescimento médio de 30% ao ano. Uma agência traz uma abordagem inovadora, incorporando as últimas tendências e tecnologias para manter sua empresa à frente da concorrência." />
        </div>
