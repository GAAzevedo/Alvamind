...
const Area3PresencaItem = ({ title, text, per }) => {
  ...
  return (
    <div className="mb-10 mt-10 text-center">
      <div data-aos="fade-up" data-aos-delay="100" className="relative flex justify-center items-center">
        <CircularProgressBarTrack radius={40} progress={100} strokeWidth={5} color="#fc9646" />
        <CircularProgressBar radius={40} progress={progress} strokeWidth={5} color="#fc9646" />
      </div>
      <h4 data-aos="fade-up" data-aos-delay="100" className="mb-3 text-center text-xl sm:text-2xl md:mb-6 md:text-3xl lg:text-4xl dark:text-zinc-300 text-zinc-700">{title}</h4>
