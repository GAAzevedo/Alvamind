    ...
    <section className="section-test">
      <div className="container-test">
        ...
        <div className="gap-8 sm:grid grid-cols-2 sm:text-lg  ">
          ...
          <Area3PresencaItem title="Engajamento nas Redes Sociais" per="75" text="Criamos estratégias envolventes que geram um aumento considerável de até 75% no engajamento nas redes sociais. Sua marca se destaca em meio à concorrência." />
