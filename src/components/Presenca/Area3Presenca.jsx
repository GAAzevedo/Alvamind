    ...
    <section className="section-test">
      <div className="container-test">
        ...
        <div className="gap-8 sm:grid grid-cols-2 sm:text-lg  ">
          ...
          <Area3PresencaItem title="Crescimento no Tráfego Orgânico" per="60" text="75% das pessoas julgam a credibilidade de um negócio com base no design do seu site. Ter um site profissional e bem projetado pode aumentar a confiança dos clientes em sua marca" />
